...
## 選択肢の制約
それぞれの選択肢は、カテゴリーレベルから異なる、本質的に多様なものである必要があります。
...
export const NEXT_ACTION_PROMPTS = {
  initial_registered: `次は**ラダリング**を実行してください。
...
有効な新選択肢を発見した場合は、選択肢を更新してください。`,
  ...
  次は**消去テスト**（バニシング・テスト）を実行してください。

**実行方法**:
1. 「今考えている選択肢がどれも取れないとする。他に何ができるか？」という前提で選択肢を考える
